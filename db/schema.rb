...
ActiveRecord::Schema.define(version: 20170209213217) do
  ...
  create_table "tour_categories", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_tour_categories_on_category_id", using: :btree
    t.index ["tour_id"], name: "index_tour_categories_on_tour_id", using: :btree
  end
